...
// Recent fees
$rf = $db->prepare("SELECT * FROM fees WHERE student_id = ? ORDER BY due_date DESC LIMIT 4");
$rf->execute([$sid]);
...
<div class="page">
    ...
    <div class="page-title">
        ...
        <p>Here's a summary of your hostel account.</p>
    </div>
    ...
    <div class="stat-row">
        <div class="stat-box">
            ...
            <div class="s-sub">All records</div>
        </div>
    ...
    <div class="grid-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="info-list">
                    ...
                    <li><span class="lbl">Date of Birth</span><span class="val"><?= $s['date_of_birth'] ? date('d M Y', strtotime($s['date_of_birth'])) : '—' ?></span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if ($s['room_id']): ?>
                    <ul class="info-list">
                        <li><span class="lbl">Room No.</span>    <span class="val"><span class="badge b-blue"><?= htmlspecialchars($s['room_number']) ?></span></span></li>
                        ...
                        <li><span class="lbl">Ensuite</span>     <span class="val">
                            <?= $s['ensuite_facility'] ? '<span class="badge b-green">Yes</span>' : '<span class="badge b-gray">Shared</span>' ?>
                        </span></li>
    ...
    <div class="card">
        ...
        <div class="tbl-wrap">
            <table>
                <thead><tr><th>Receipt</th><th>Type</th><th>Amount</th><th>Due Date</th><th>Status</th></tr></thead>
                <tbody>
